...
public class BookingController {
    ...
    @PostMapping
    public BookingDto create(@RequestBody @Valid BookingDto bookingDto, @RequestHeader(Utility.X_SHARER_USER_ID) Long id) {
       return bookingService.create(bookingDto, id);
    }

    @PatchMapping("/{id}")
    public BookingDto approve(@PathVariable Long id, @RequestParam Boolean approved,
